...
if (isset($_POST['valider'])) {
    ...
    $requete = "INSERT INTO commande( user, phone, mail, adress, nom) VALUES ( :user, :phone, :email, :adress, :nom)";

    $add = $connexion->prepare($requete);

    $add->execute(array(":user" => $user, ":phone" => $phone, ":email" => $email, ":adress" => $adress, ":nom" => $nom));

    header("Location: ./boutique.php?msg=Vous avez reuissi a payer votre commande");
}
