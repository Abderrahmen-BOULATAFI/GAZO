...
if (isset($_POST['valider'])) {
    ...
    $requete = "INSERT INTO tour (image, nom, prix, date, club) VALUES (:image, :nom, :prix, :date, :club)";
    ...
    <div class="container">
        ...
        <form action="" method="post">
            ...
            <div class="form-group">
                ...
                <input type="date" id="date" name="date" placeholder="Date de concert" required>
            </div>
            <div class="form-group">
                <label for="club">Nom-Club :</label>
                <input type="text" id="club" name="club" placeholder="Nom de club" required>
            </div>

            <button type="submit" name="valider">ajouter le produit</button>
            <div class="sign">
                <p class="paragraphe-creationdecompte">Vous voulez voir la page tour client ? &nbsp; </p>
                <a class="sigup" href="../../CLIENT/toure/tour.php"> appuiez ici.</a>
            </div>
        </form>
    </div>
</body>
